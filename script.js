...
let merch_item_des = document.querySelectorAll('.merch-item-descr')
let merch_item = ['Тарелка с принтом Марса. Доступна в ...','Кружка с принтом Марса. Доступна в ...', 'Масштабная модель одной из ракет Galaxy', 'Масштабная модель марсахода (мы покупаем и ...']
let merch_cost = document.querySelectorAll('.merch-item-price')
let cost = ['1000','1000','2500','5000']
for (let i = 0; i < 4; i += 1) {
    merch_item_des[i].innerHTML = merch_item[i]
    merch_cost[i].innerHTML = cost[i]
}
